          ...
          <div className="flex flex-col items-start text-left space-y-8 max-w-2xl">
            ...
            >
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-white leading-tight">
                ...
                <span className="text-primary-foreground bg-primary/20 px-4 rounded-lg backdrop-blur-sm">
                  Reimagined
                </span>
              </h1>
            </motion.div>
            ...
            >
              Connect with specialized doctors, manage appointments, and prioritize your mental
              well-being with MindMate's secure and compassionate platform.
            </motion.p>
            ...
            >
              <Link to="/register">
                <Button
                  size="lg"
                  className="rounded-full px-8 text-lg h-12 shadow-xl shadow-primary/20 hover:shadow-2xl hover:shadow-primary/30 transition-all"
                >
              ...
              <Link to="/doctors">
                <Button
                  variant="outline"
                  size="lg"
                  className="rounded-full px-8 text-lg h-12 bg-white/10 backdrop-blur-md border-white/30 text-white hover:bg-white/20"
                >
                  Find a Doctor
                </Button>
              </Link>
          ...
          <div className="bg-primary rounded-3xl p-8 md:p-12 lg:p-16 text-center text-primary-foreground relative overflow-hidden shadow-2xl shadow-primary/25">
            <div className="relative z-10 max-w-2xl mx-auto space-y-6">
              ...
              <p className="text-primary-foreground/80 text-lg">
                Join thousands of patients who have found support and healing through MindMate.
              </p>
              <Link to="/register">
                <Button
                  size="lg"
                  variant="secondary"
                  className="rounded-full px-8 text-lg h-12 font-semibold text-primary hover:bg-white"
                >
                  Join Now - It's Free
                </Button>
              </Link>

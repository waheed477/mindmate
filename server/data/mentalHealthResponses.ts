...
export const mentalHealthResponses = [
  ...
  // ==================== CRISIS & EMERGENCY RESOURCES (INTERNATIONAL) ===========
  {
  ...
  // ==================== PAKISTAN CRISIS & EMERGENCY RESOURCES ===========
  {
    keywords: ["pakistan help", "pakistan crisis", "pakistan mental health", "umang", "umeed", "rozan", "edhi", "pakistan helpline", "karachi help", "lahore help", "islamabad help"],
    response: "You are not alone — help is available in Pakistan right now. Please reach out:\n\n🇵🇰 **Pakistan Crisis & Mental Health Helplines:**\n\n• **Umang** (Psychiatric Helpline): **0317-4288665** — Free, confidential, mental health support\n• **Rozan Counselling** (Islamabad): **051-2890505** — Trauma, abuse, and mental health counselling\n• **Edhi Foundation**: **115** — 24/7 emergency response across Pakistan\n• **Rohi Sehat** (Punjab): **0800-45525** — Free mental health helpline (toll-free)\n• **Pakistan Suicide Prevention**: **051-111-911-911** (Umeed-e-Nau)\n• **Emergency / Rescue**: **1122** (Punjab) | **1020** (Karachi)\n\n**Umeed-e-Nau** specifically supports those in emotional distress and suicidal crisis.\n\nYour life has value. Please call right now — these services exist for exactly this moment."
  },
  {
    keywords: ["umeed e nau", "umeed-e-nau", "suicide pakistan", "pakistan suicide prevention"],
    response: "**Umeed-e-Nau** is Pakistan's dedicated suicide prevention and crisis support service.\n\n📞 **Call: 051-111-911-911** — Available for emotional distress and suicidal crisis\n\nThey provide:\n• Immediate crisis intervention\n• Confidential emotional support\n• Referrals to mental health professionals\n\nAlso available:\n• **Umang**: 0317-4288665 — trained counsellors for depression, anxiety, and crisis\n• **Edhi Foundation**: 115 — 24/7 emergency response nationwide\n\nYou are not a burden. Reaching out is the bravest thing you can do right now. Please call — they are trained to help."
  },
  {
    keywords: ["edhi", "edhi foundation", "pakistan emergency"],
    response: "**Edhi Foundation** is one of Pakistan's largest welfare organizations providing emergency and mental health support:\n\n📞 **Edhi Helpline: 115** — Free, 24/7, nationwide\n\nServices include:\n• Emergency response and ambulance\n• Shelter for those in crisis\n• Support for vulnerable individuals\n\nFor mental health specific support:\n• **Umang Helpline**: 0317-4288665\n• **Rozan Counselling** (Islamabad): 051-2890505\n• **Umeed-e-Nau**: 051-111-911-911\n\nIf you or someone you know is in immediate danger, call **115** or **1122** (Punjab rescue)."
  },
  ...
  {
    keywords: ["meditate", "meditation", "mindfulness", "breathing exercise", "calm down", "deep breathing", "panic attack breathing"],
    response: "Mindfulness and breathing exercises are among the most evidence-backed tools for mental health. Let's try one right now:\n\n**Box Breathing (4-4-4-4)**:\n1. Breathe IN slowly for 4 counts\n2. HOLD for 4 counts\n3. Breathe OUT slowly for 4 counts\n4. HOLD for 4 counts\nRepeat 4 times.\n\n**5-4-3-2-1 Grounding**:\n• 5 things you can SEE\n• 4 things you can TOUCH\n• 3 things you can HEAR\n• 2 things you can SMELL\n• 1 thing you can TASTE\n\nEven 5 minutes of mindfulness daily has measurable effects on anxiety and stress hormones. Apps like Headspace, Calm, or Insight Timer can guide you. Which technique feels most accessible right now?"
  },
  {
    keywords: ["can't breathe", "hyperventilating", "breathing fast", "chest tight", "shortness of breath"],
    response: "If you're hyperventilating, let's slow this down together right now.\n\n**Try this immediately**: Breathe out FIRST — a long, slow exhale. Your body needs to expel CO2 before it can calm down.\n\n1. Breathe OUT fully through your mouth (like fogging a mirror)\n2. Pause 2 seconds\n3. Breathe IN slowly through your nose for 4 counts\n4. OUT slowly for 6 counts\n\nKeep the exhale longer than the inhale — this activates the parasympathetic nervous system (your body's 'rest' mode).\n\nAre you safe right now? What triggered this? I'm here with you."
  },
  {
    keywords: ["grounding", "ground myself", "feel grounded", "reality check", "dissociating", "feel unreal", "not real"],
    response: "Dissociation and feeling unreal can be frightening. Your brain is trying to protect you from overwhelm — but let's bring you back to the present.\n\n**Grounding techniques RIGHT NOW**:\n• Hold something cold (ice cube, cold water on wrists)\n• Press your feet flat on the floor and feel the ground\n• Name out loud: 5 colors you see, 4 textures you feel, 3 sounds\n• Smell something strong (coffee, citrus, peppermint)\n• Say your name, today's date, where you are out loud\n\nThese interrupt the dissociation loop by engaging your senses. How are you feeling right now — is it getting a little better?"
  },

  // ==================== SLEEP & FATIGUE ====================
  {
    keywords: ["can't sleep", "insomnia", "trouble sleeping", "sleep problems", "sleep disorder", "awake at night", "nightmares"],
    response: "Sleep problems both cause and worsen mental health struggles — it's a hard cycle to break, but very treatable.\n\n**Science-backed sleep hygiene**:\n• Consistent sleep/wake time (even weekends) — most important\n• No screens 60 min before bed (blue light suppresses melatonin)\n• Cool room (65-68°F / 18-20°C) ideal\n• No caffeine after 2pm\n• Use bed only for sleep (not work/TV)\n\n**CBT for Insomnia (CBT-I)** is more effective than sleep medication long-term. The free app *Sleepio* uses CBT-I.\n\n**For right now**: Try progressive muscle relaxation — tense each muscle group for 5 seconds, then release, starting from your toes up to your face.\n\nHow long have you been struggling with sleep? Any idea what's keeping you awake?"
  },
  {
    keywords: ["tired all the time", "exhausted", "fatigue", "no energy", "always sleepy", "burnt out feeling"],
    response: "Persistent exhaustion that rest doesn't fix is one of the most common and most misunderstood symptoms — it can signal depression, burnout, anemia, thyroid issues, sleep apnea, or simply chronic overload.\n\n**Questions to explore**:\n• Are you sleeping 7-9 hours but still exhausted? (Suggests sleep quality issue or mood disorder)\n• Has your energy gradually declined or crashed suddenly?\n• Do you feel more tired after social interactions? (Could signal introversion-related drain or social anxiety)\n\n**Quick energy check**: Rate your morning energy 1-10 for 7 days. If it's consistently below 4, bring this to a doctor — it warrants investigation.\n\nWhat does your exhaustion feel like — more physical, emotional, or like your brain just won't work?"
  },

  // ==================== ANGER & FRUSTRATION ====================
  {
    keywords: ["angry", "anger", "so angry", "furious", "rage", "can't control anger", "explosive", "anger issues"],
    response: "Anger is a valid, natural emotion — but when it feels out of control, it usually means there's something important underneath it: pain, injustice, fear, or unmet needs.\n\n**In the moment** (when rage peaks):\n• Leave the situation physically if possible (pause — not escape)\n• Cold water on your face or wrists (triggers the dive reflex, slows heart rate)\n• 4-second inhale, 8-second exhale — repeat 3 times\n• Name what you feel: \"I am ANGRY because...\"\n\n**Long term**: Anger management therapy (especially CBT and DBT) is highly effective. Exercise is also one of the best anger regulators.\n\nWhat tends to trigger your anger most? Is it specific situations, people, or does it feel more like a constant simmer?"
  },
  {
    keywords: ["frustrated", "frustration", "so frustrated", "nothing is working", "keep failing", "giving up"],
    response: "Frustration tells you that you care deeply about something — and that what you're doing isn't working *yet*. That's uncomfortable but it means you're engaged, not broken.\n\n**Reframe**: Frustration often comes before a breakthrough. It means you're at the edge of your current capacity — and that edge is where growth happens.\n\n**Practical reset**:\n• Step away from the problem completely for 30 minutes\n• Do something physical (walk, stretch)\n• Write down what IS working, even small things\n• Ask: 'What's one different approach I haven't tried?'\n\nWhat are you frustrated about? Sometimes talking it through reveals a solution or at least makes the weight lighter."
  },
  {
    keywords: ["irritable", "irritated", "snapping", "short temper", "easily annoyed", "everything annoys me"],
    response: "Irritability is often a signal of something else going on underneath — sleep deprivation, depression (especially in men), anxiety, burnout, hormonal changes, or unprocessed stress.\n\nIt can feel embarrassing to admit, especially if you're snapping at people you love. But recognizing it is the first step.\n\n**Check**: When did the irritability start? Did something change around that time (sleep, stress, life events, medication)?\n\n**Immediate help**: A high-protein snack (low blood sugar triggers irritability), 10 minutes outside, or a brief physical activity can shift the baseline quickly.\n\nIs the irritability constant, or are there times of day or specific triggers when it gets worse?"
  },

  // ==================== RELATIONSHIPS ====================
  {
    keywords: ["toxic relationship", "toxic partner", "abusive relationship", "emotional abuse", "domestic violence", "he hurts me", "she hurts me", "partner hits me"],
    response: "What you're describing sounds serious, and your safety matters most. Emotional, physical, and psychological abuse are never your fault — and they tend to escalate over time.\n\n**Signs of an abusive relationship**:\n• Constant criticism or belittling\n• Controlling behavior (money, contacts, movement)\n• Threats or intimidation\n• Physical harm or the fear of it\n\n**Resources**:\n• **National DV Hotline**: 1-800-799-7233 (TTY: 1-800-787-3224) — 24/7, confidential\n• Text START to 88788\n• Chat at thehotline.org\n\nIf you're in immediate danger, please call 911.\n\nYou don't have to make any decisions today. Can you tell me more about what's been happening?"
  },
  {
    keywords: ["breakup", "broke up", "ex", "heartbreak", "ended relationship", "dumped", "she left me", "he left me"],
    response: "Breakups activate the same brain regions as physical pain — what you're feeling isn't weakness, it's neuroscience. Healing from a breakup is real grief, and it takes time.\n\n**What helps** (backed by research):\n• Allow yourself to feel sad — suppression makes it worse\n• Limit contact with your ex, especially on social media (each 'check' reopens the wound)\n• Stay connected to friends — isolation makes heartbreak worse\n• Physical exercise — releases endorphins and reduces cortisol\n• Give yourself a timeline ('I'll feel this for a while, and that's okay') — research shows most people feel significantly better within 3 months\n\nHow long ago did the breakup happen? And what feels hardest right now — the loneliness, the loss of the person, or the loss of the future you had imagined?"
  },
  {
    keywords: ["loneliness", "lonely", "no friends", "isolated", "no one cares", "feel alone", "all alone"],
    response: "Loneliness is one of the most painful human experiences — and ironically, one of the most common. Studies show it's as damaging to health as smoking 15 cigarettes a day.\n\nYou feeling alone doesn't mean you ARE alone in this — it means you need connection, and that's a deeply human need.\n\n**Building connection when isolated**:\n• Start small: one intentional conversation per day (barista, colleague, neighbor)\n• Join a recurring group (class, club, volunteer work) — repeated casual exposure builds connection naturally\n• Online communities can be a bridge, not a replacement\n• Therapy provides a real, consistent human connection while you build others\n\nIs the loneliness situational (new city, after a loss) or has it been long-term? That affects what will help most."
  },
  {
    keywords: ["family problems", "family conflict", "parents fighting", "toxic family", "dysfunctional family", "estranged family"],
    response: "Family pain cuts especially deep because those relationships shape our earliest understanding of safety, love, and belonging. Conflict or distance from family can leave a specific kind of wound.\n\n**Some realities that might help**:\n• You can love someone and still need distance from them for your own health\n• Setting limits with family is not disloyalty — it's self-preservation\n• You are allowed to grieve the family you needed but didn't have\n• 'Family first' doesn't mean 'family at the cost of yourself'\n\nWhat's going on with your family right now? Are you looking for ways to improve the relationship, create some distance, or just process how you're feeling about it?"
  },
  {
    keywords: ["trust issues", "can't trust anyone", "betrayed", "betrayal", "lied to", "cheated on"],
    response: "Betrayal — especially by someone you trusted deeply — is one of the most disorienting experiences. It doesn't just hurt in the moment; it can fundamentally shift how safe the world feels.\n\n**What happens after betrayal**:\n• Difficulty trusting others (or over-trusting — both are common responses)\n• Hypervigilance for signs of deception\n• Grief, anger, and confusion cycling unpredictably\n• Intrusive thoughts replaying what happened\n\nThis often meets the criteria for betrayal trauma, which responds well to therapy (especially EMDR and trauma-focused CBT).\n\nYou don't have to 'get over it' on anyone else's timeline. Who betrayed you, if you're willing to share?"
  },

  // ==================== WORK & CAREER ====================
  {
    keywords: ["work stress", "job stress", "workplace anxiety", "toxic workplace", "bad boss", "work is killing me", "hate my job"],
    response: "Work stress is one of the leading causes of anxiety and depression worldwide — and toxic workplaces do real damage to mental health over time.\n\n**Coping while you're still there**:\n• Strict boundaries between work time and personal time — no emails after hours\n• Micro-recoveries during the day (5-min walk, eyes-closed breathing)\n• Document everything if the environment is abusive\n• Build your support network outside work\n\n**The bigger question**: Is this job fixable (new manager, department, boundaries) or fundamentally incompatible with your wellbeing?\n\nNo job is worth chronic anxiety, depression, or physical illness. I know that's easy to say and harder to act on.\n\nWhat's making work most unbearable right now?"
  },
  {
    keywords: ["fired", "lost job", "laid off", "unemployed", "job loss", "lost my job"],
    response: "Losing a job is a genuine life crisis — it can shake your identity, security, and sense of purpose all at once. Whatever you're feeling right now (shock, relief, shame, fear) is valid.\n\n**What tends to help**:\n• Allow yourself a few days to process before 'activating' — this is a loss and grief is appropriate\n• Separate your worth from your employment — your job is what you do, not who you are\n• Structure your days even without work — this prevents the spiral of unstructured time\n• Reconnect with your network (most jobs come through people, not applications)\n\n**Resources**: If you're in the US, file for unemployment benefits immediately — many people delay and miss weeks of coverage.\n\nHow long ago did this happen? And what feels most pressing right now — the financial anxiety, the identity piece, or just the uncertainty?"
  },
  {
    keywords: ["imposter syndrome", "feel like a fraud", "don't deserve this", "they'll find out", "not qualified enough"],
    response: "Imposter syndrome affects an estimated 70% of people at some point — including many highly successful people. The very fact that you're worried you're not good enough often means you ARE good enough (people who genuinely aren't capable rarely worry about it this deeply).\n\n**What helps**:\n• Keep a 'wins' journal — write down what you did well each week, even small things\n• Ask: 'What evidence actually supports the belief that I'm a fraud?'\n• Normalize it by talking to peers — you'll find out you're not alone\n• Remember: competence and confidence are separate skills. You may be competent before you feel confident.\n\n**Reframe**: You're not faking it — you're learning, which is what everyone at your level is doing.\n\nWhat specifically makes you feel like a fraud?"
  },
  {
    keywords: ["overworking", "working too much", "workaholic", "can't stop working", "always working", "no work life balance"],
    response: "Working excessively often feels productive but can mask anxiety, fear of failure, difficulty resting, or an identity deeply tied to achievement.\n\n**Warning signs you're overworking**:\n• You feel guilty when you're NOT working\n• You can't remember your last vacation or true day off\n• Relationships and health are suffering\n• You work to avoid feelings or situations at home\n\n**The paradox**: Research shows overwork decreases productivity and creativity significantly. Rest isn't laziness — it's recovery that makes the work better.\n\nTry this: schedule one completely work-free hour this week. Notice what feelings come up when you try to stop. That's often the real information.\n\nWhat do you think drives the overworking for you?"
  },

  // ==================== SELF-ESTEEM & CONFIDENCE ====================
  {
    keywords: ["no confidence", "lack of confidence", "low self esteem", "self esteem", "don't believe in myself", "feel inferior"],
    response: "Low self-esteem isn't a personality flaw — it's usually learned, often from childhood experiences, criticism, or environments where you didn't feel valued.\n\nThe good news: it can be unlearned.\n\n**Practical starting points**:\n• **Behavioral experiment**: Act 'as if' you were slightly more confident in ONE specific situation this week. Notice what happens.\n• **Inner critic log**: Write down self-critical thoughts, then ask 'Would I say this to a friend in the same situation?'\n• **Competence builds confidence**: Pick one skill and work at it — concrete evidence of ability counters abstract self-doubt\n• **Reduce social comparison** — especially on social media\n\nTherapy (especially schema therapy and CBT) has excellent outcomes for long-term low self-esteem.\n\nIn what areas do you feel most insecure? And where do you feel most like yourself?"
  },
  {
    keywords: ["ugly", "hate my appearance", "hate how i look", "body image", "fat", "too thin", "not attractive"],
    response: "Body image struggles are incredibly common — especially in a world that profits from making you feel inadequate about your appearance. What you're feeling has a lot to do with impossible standards, not your actual body.\n\n**Important distinction**: Disliking your body is different from an eating disorder. Both deserve support, but eating disorders (anorexia, bulimia, binge eating) need professional treatment specifically.\n\n**What helps with body image**:\n• Unfollow accounts that make you feel bad about your body\n• Body neutrality (not 'love your body' — just 'my body allows me to exist') is more achievable than body positivity\n• Notice what your body CAN do, not just how it looks\n• Work with a therapist trained in body image or disordered eating\n\nCan I ask — when did you start feeling this way? And does it affect daily activities like eating, exercising, or going out?"
  },
  {
    keywords: ["compare myself", "comparing myself", "jealous", "jealousy", "envy", "why can't i be like them"],
    response: "Social comparison is hardwired into the human brain — it evolved as a survival mechanism. The problem is it was designed for small groups where comparisons were realistic, not for comparing yourself to the global highlight reel of billions of people online.\n\n**The comparison trap**:\n• You see others' outsides, you know your insides — unfair comparison\n• Social media shows the 1% of someone's best moments\n• Upward comparison (comparing yourself to people 'above') increases anxiety; lateral comparison (peers) can motivate\n\n**What to try**:\n• Compare yourself to who you were yesterday, not who someone else is today\n• Turn jealousy into information: 'What does this tell me I actually want?'\n• Limit social media to time-boxed windows\n\nWho or what do you find yourself comparing yourself to most?"
  },

  // ==================== TRAUMA & PTSD ====================
  {
    keywords: ["trauma", "traumatic", "traumatic experience", "past trauma", "can't forget", "haunted by", "ptsd symptoms"],
    response: "Trauma isn't just the event that happened — it's the lasting effect on your nervous system. Your brain is doing exactly what it was designed to do: protect you by staying alert to danger. But sometimes that system stays activated long after the danger has passed.\n\n**Common trauma responses** (all valid, all treatable):\n• Flashbacks or intrusive memories\n• Hypervigilance (always 'on guard')\n• Avoidance of reminders\n• Emotional numbness or overwhelm\n• Difficulty trusting people or feeling safe\n\n**Evidence-based treatments for trauma**:\n• **EMDR** (Eye Movement Desensitization and Reprocessing) — highly effective\n• **Trauma-focused CBT**\n• **Somatic therapy** (body-based trauma processing)\n\nYou don't have to 'get over it' or 'move on.' Healing from trauma is possible with the right support. What's been hardest to live with?"
  },
  {
    keywords: ["flashback", "flashbacks", "triggered", "intrusive thoughts", "memories won't stop", "can't stop thinking about it"],
    response: "Flashbacks and intrusive memories are the mind's way of trying to process something it never fully worked through. The memory stays 'live' because it hasn't been integrated.\n\n**When a flashback hits**:\n1. Say to yourself: 'This is a memory, not the present moment. I am safe right now.'\n2. Orient to your surroundings — name 5 things you see\n3. Touch something textured and focus on the sensation\n4. Put both feet on the floor\n5. Take slow, controlled breaths\n\n**Long-term**: Intrusive thoughts respond very well to EMDR therapy — many people see dramatic improvement in 6-12 sessions. Regular mindfulness also reduces intrusion frequency over time.\n\nHow often are the intrusive thoughts happening? And is there a pattern to what triggers them?"
  },

  // ==================== SUBSTANCE USE ====================
  {
    keywords: ["drinking too much", "alcohol problem", "can't stop drinking", "alcoholic", "alcohol addiction", "binge drinking"],
    response: "Acknowledging a problem with alcohol takes real courage — most people struggle for years before saying it out loud.\n\nAlcohol is particularly tricky because it's socially normalized, legal, and initially feels like it helps with anxiety, sleep, and social ease. But over time, it rewires the brain to need more to get the same effect.\n\n**Important medical note**: If you drink heavily daily, do NOT stop cold turkey without medical supervision — alcohol withdrawal can be dangerous (seizures). Talk to a doctor first.\n\n**Resources**:\n• **SAMHSA**: 1-800-662-4357 (free, 24/7)\n• **AA**: aa.org — free peer support, widely available\n• **SMART Recovery**: smartrecovery.org — science-based alternative to AA\n• Medication-assisted treatment (naltrexone, Vivitrol) is effective and underused\n\nWhat does your drinking look like — is it daily, binge-style, or situational?"
  },
  {
    keywords: ["drug addiction", "can't stop using", "addiction", "substance abuse", "relapse", "relapsed"],
    response: "Relapse and addiction are not moral failures — they're features of how the addicted brain functions, and they don't undo your progress.\n\n**The relapse statistic**: 40-60% of people in recovery experience at least one relapse. What matters is what you do next, not that it happened.\n\n**Right now, after a relapse**:\n• Don't catastrophize — one relapse isn't the end of recovery\n• Tell your sponsor, therapist, or support person\n• Identify the trigger — what happened before? Stress? A person? A situation?\n• Return to your recovery plan, or make a new one\n\n**Resources**:\n• SAMHSA: 1-800-662-4357\n• NA (Narcotics Anonymous): na.org\n• Medication-assisted treatment works for opioid and alcohol addiction\n\nAre you connected to a recovery program or treatment? What does your support system look like right now?"
  },

  // ==================== SPECIFIC CONDITIONS ====================
  {
    keywords: ["bipolar", "mania", "manic", "mood swings", "extreme moods", "highs and lows"],
    response: "Bipolar disorder involves real neurological differences in how the brain regulates mood — it's not weakness, drama, or instability of character.\n\n**The two main types**:\n• **Bipolar I**: Full manic episodes (may include psychosis) with depressive episodes\n• **Bipolar II**: Hypomanic episodes (less intense) with depressive episodes\n\n**During a manic/hypomanic phase**:\n• Decreased need for sleep without feeling tired\n• Racing thoughts, increased talkativeness\n• Impulsivity (spending, risky decisions, sexual behavior)\n• Grandiosity or elevated mood\n\nIf this sounds familiar, please see a psychiatrist — bipolar responds very well to mood stabilizers (lithium, lamotrigine, valproate), but antidepressants alone can trigger mania.\n\nAre you currently under psychiatric care? And what phase feels most difficult to manage?"
  },
  {
    keywords: ["ocd", "obsessive compulsive", "intrusive thoughts ocd", "compulsions", "rituals", "checking", "contamination fear"],
    response: "OCD is one of the most misunderstood conditions — it's not about being 'neat' or organized. It's an anxiety disorder where intrusive thoughts create intense distress, and compulsions are used to temporarily relieve that distress.\n\n**Key insight**: Compulsions provide short-term relief but long-term make OCD worse — they 'confirm' to the brain that the threat was real and needs more checking.\n\n**Gold-standard treatment**: ERP (Exposure and Response Prevention) — a specialized form of CBT. It works by gradually facing feared situations WITHOUT doing the compulsion until anxiety naturally decreases.\n\nGeneral CBT isn't enough for OCD — find a therapist specifically trained in ERP. The IOCDF (ocd.org) has a therapist directory.\n\n**SSRI medications** (higher doses than for depression) are also effective for OCD.\n\nWhat do the intrusive thoughts or compulsions focus on for you?"
  },
  {
    keywords: ["eating disorder", "not eating", "starving myself", "anorexia", "bulimia", "binge eating", "purging", "throwing up food"],
    response: "Eating disorders have the highest mortality rate of any mental health condition — and they are also highly treatable. Reaching out is a really important step.\n\n**Please know**:\n• You deserve to recover, regardless of what you weigh or how 'severe' your symptoms seem\n• Eating disorders are not about vanity — they are complex psychological disorders\n• Recovery is fully possible, even after years of struggle\n\n**Resources**:\n• **NEDA Helpline**: 1-800-931-2237 (call or text NEDA to 741741)\n• neda.org — screening tool, find treatment\n• Crisis chat: nationaleatingdisorders.org/help-support/contact-helpline\n\nIf you're medically compromised (dizziness, heart palpitations, fainting), please seek medical attention first.\n\nCan you tell me more about what's been happening? How long have you been struggling with this?"
  },
  {
    keywords: ["adhd", "attention deficit", "can't focus", "can't concentrate", "easily distracted", "brain won't stop", "forgetful"],
    response: "ADHD is a neurodevelopmental difference — not laziness, lack of willpower, or intelligence. The ADHD brain has differences in dopamine regulation that make sustained attention, impulse control, and executive function genuinely harder.\n\n**Common ADHD struggles beyond 'can't focus'**:\n• Time blindness (underestimating how long things take)\n• Emotional dysregulation (frustration, rejection sensitivity)\n• Working memory gaps\n• Hyperfocus on interesting things but total shutdown on boring ones\n\n**Evidence-based support**:\n• Formal evaluation and diagnosis (psychiatrist or psychologist)\n• Medication (stimulants or non-stimulants) — highly effective\n• Coaching and CBT for ADHD\n• Environmental adjustments (body-doubling, timers, visual reminders)\n\nAre you formally diagnosed, or do you suspect you might have ADHD? And how is it affecting your life most right now?"
  },

  // ==================== SOCIAL ANXIETY & CONFIDENCE ====================
  {
    keywords: ["social anxiety", "scared of people", "nervous around people", "can't talk to people", "what will people think"],
    response: "Social anxiety is the third most common mental health condition — you are far from alone. The core is a fear of negative evaluation: 'What will people think of me? Will they judge me? Will I embarrass myself?'\n\nThe cruel irony is that social anxiety often makes you more self-aware and thoughtful — traits other people actually appreciate.\n\n**What helps**:\n• **CBT** specifically for social anxiety has excellent outcomes (60-80% significant improvement)\n• **Exposure therapy** — gradually facing feared social situations\n• **Cognitive restructuring**: Test the anxious predictions against reality\n• **Mindfulness**: Shift attention outward (to the conversation) rather than inward (to yourself)\n\n**In the moment**: Focus on the other person — what are they saying? Being genuinely curious about others takes attention off yourself.\n\nWhat social situations feel hardest for you?"
  },
  {
    keywords: ["public speaking", "speaking anxiety", "fear of speaking", "presentations", "scared to speak up"],
    response: "Public speaking anxiety is the most common phobia — even many professional speakers experience it. The goal isn't to eliminate nerves (some adrenaline improves performance), but to keep them from overwhelming you.\n\n**Practical techniques**:\n• **Reframe arousal**: Research shows telling yourself 'I'm excited' (instead of 'I'm nervous') improves performance — the physiological states are identical\n• **Prepare deeply, rehearse out loud** — most anxiety comes from uncertainty\n• **Find a friendly face** in the audience and speak to them\n• **Slow down**: Anxiety speeds up speech. Deliberate pausing feels powerful to the audience\n• **Breathe out fully** right before you start\n\nWith practice and gradual exposure, public speaking anxiety reduces significantly for most people.\n\nWhat's the speaking situation you're most dreading? Let's work through it."
  },

  // ==================== SPECIFIC LIFE EVENTS ====================
  {
    keywords: ["divorce", "getting divorced", "marriage problems", "marriage is over", "separated"],
    response: "Divorce is one of the most significant life stressors a person can experience — even when it's the right decision, it involves grief, identity shift, practical upheaval, and often co-parenting complexity.\n\n**What you may be feeling** (all valid):\n• Relief and sadness simultaneously\n• Shame or failure (especially if you didn't want the divorce)\n• Fear about the future\n• Anger at your partner or yourself\n\n**Practically**:\n• Lean on your support network — isolation makes this much harder\n• Consider therapy — divorce is one of the most common reasons people start\n• If children are involved, keep conflict away from them as much as possible\n• Give yourself a year — research shows most people adapt significantly within 1-2 years\n\nWhat feels most overwhelming about this right now?"
  },
  {
    keywords: ["death", "someone died", "lost someone", "grief", "grieving", "bereavement", "they're gone", "passed away", "funeral"],
    response: "I'm so deeply sorry for your loss. Grief is one of the most profound human experiences, and there's no right way to do it.\n\n**About grief**:\n• The 'stages' of grief (denial, anger, bargaining, depression, acceptance) are not linear — most people cycle through them repeatedly and non-sequentially\n• Grief doesn't have a timeline. Feeling intense grief months or years later is completely normal\n• Grief can be physical: fatigue, difficulty eating, chest heaviness, difficulty concentrating\n• Grief after complicated relationships (estranged, abusive, ambivalent) can be especially confusing\n\n**What helps**:\n• Allowing yourself to feel it (resistance prolongs grief)\n• Continuing small routines\n• Talking about the person who died — telling stories, sharing memories\n• Grief counseling or support groups (GriefShare, Compassionate Friends for child loss)\n\nWould you like to tell me about them?"
  },
  {
    keywords: ["moving away", "new city", "relocated", "homesick", "miss home", "don't know anyone"],
    response: "Moving — especially to a new city where you don't know anyone — is a genuine psychological adjustment that often takes longer than people expect (research suggests 6-12 months to feel settled).\n\n**What makes it hard**: Loneliness, loss of familiar routines and people, identity uncertainty, practical overwhelm — all at once.\n\n**Building a life in a new place**:\n• Repeated exposure to the same place or group is how friendships form (meetup.com, gym classes, community events, volunteer work)\n• Say yes to invitations, even if you're tired\n• Build routines in your neighborhood — coffee shop, grocery store, park — familiarity reduces anxiety\n• Give it at least 6 months before judging whether you like it\n\nHow long have you been in the new place? And do you have any connections there yet, even loose ones?"
  },
  {
    keywords: ["financial stress", "money problems", "debt", "can't afford", "broke", "financial anxiety"],
    response: "Financial stress is one of the most concrete and relentless forms of anxiety — because unlike many worries, it has real and immediate consequences.\n\nFinancial stress affects sleep, relationships, concentration, and physical health — it's a genuine mental health burden, not a personality weakness.\n\n**Immediate relief**:\n• Write out the actual numbers — anxiety often makes the situation feel worse than it is\n• Identify one small actionable step (call a creditor, cancel one subscription, look up one resource)\n• NFCC (nfcc.org) offers free nonprofit credit and debt counseling\n\n**On the emotional side**:\n• Money shame is very common — you can talk to me about this without judgment\n• Anxiety about money can lead to avoidance (not opening mail, ignoring accounts) which always makes it worse\n\nWhat's the financial situation, roughly? And what feels most urgent?"
  },

  // ==================== IDENTITY & LGBTQ+ ====================
  {
    keywords: ["coming out", "gay", "lesbian", "bisexual", "queer", "trans", "transgender", "gender identity", "sexuality confusion"],
    response: "Questions about identity and sexuality are deeply personal — and navigating them, especially when you're uncertain or unsupported, can be incredibly isolating.\n\nFirst: **there is no timeline** you have to follow. You don't owe anyone a label or an announcement.\n\n**What many people find helpful**:\n• Connecting with others who share your experience (online or in-person LGBTQ+ communities)\n• A therapist with LGBTQ+ affirmative training\n• Resources: The Trevor Project (for under 25), PFLAG, GLSEN\n\n**On coming out**: You get to decide who knows, when, and how. You don't have to come out to everyone at once (or at all). Safety comes first.\n\nIs there a specific aspect of identity you're working through? Or is it more about how to navigate others' reactions?"
  },

  // ==================== POSITIVE & PROGRESS ====================
  {
    keywords: ["i'm doing better", "feeling better", "progress", "getting better", "things are improving"],
    response: "That's genuinely wonderful to hear. 💙 Progress in mental health is real and worth celebrating — even when it comes in small, uneven steps.\n\nNotice what contributed to feeling better — was it something you changed? Something that shifted externally? A conversation, a habit, a decision? Understanding what helps YOU is valuable data for the harder days.\n\nRemember: setbacks don't erase progress. If harder days come again, you now have evidence that better days are possible — because you've lived them.\n\nWhat's been making the biggest difference?"
  },
  {
    keywords: ["happy", "feeling happy", "good day", "great day", "doing well", "things are good"],
    response: "That genuinely makes me smile to hear. 💙 Good days matter — not just as relief from hard ones, but as reminders of what life can feel like.\n\nThis is actually a great time to do something small but meaningful: note what made today good. What did you do? Who were you with? What were you thinking about? Building awareness of what creates good days helps you intentionally make more of them.\n\nWhat made today particularly good?"
  },
  {
    keywords: ["therapy", "therapist", "psychiatrist", "psychologist", "counseling", "mental health professional", "should i see a therapist"],
    response: "Reaching out to a mental health professional is one of the most effective things you can do for your wellbeing — and asking 'should I?' is already a sign it might be worth trying.\n\n**You don't have to be in crisis to benefit from therapy.** It's also for:\n• Stress management and life challenges\n• Understanding patterns in your behavior and relationships\n• Building coping skills\n• Personal growth\n\n**Types of professionals**:\n• **Therapist/Counselor**: Talks therapy, wide range of approaches\n• **Psychologist**: PhD-level, can provide assessment/testing\n• **Psychiatrist**: Medical doctor, can prescribe medication\n\n**Finding one**:\n• Psychology Today directory: psychologytoday.com\n• Open Path Collective: sliding scale fees\n• Ask your primary care doctor for referrals\n\nYou can always book an appointment with one of MindMate's doctors here on the platform — they're here to help. What's holding you back, if anything?"
  },
  {
    keywords: ["medication", "antidepressant", "ssri", "should i take medication", "mental health medication", "scared of medication"],
    response: "Concerns about medication are incredibly common and worth exploring openly.\n\n**What the research says**: For moderate-to-severe depression and anxiety, medication combined with therapy has better outcomes than either alone. Medication is not 'giving up' — it's a medical tool.\n\n**Common concerns addressed**:\n• *'I'll become dependent'*: SSRIs/SNRIs are not addictive in the clinical sense; stopping does require tapering\n• *'It will change who I am'*: Many people report feeling 'more themselves' — like the illness was the thing changing them\n• *'It's a life sentence'*: Many people take antidepressants for 6-12 months and successfully taper off\n• *'Side effects'*: Real, but usually temporary in the first 2 weeks; often manageable with dose adjustment\n\nOnly a psychiatrist or doctor can prescribe and monitor medication safely. On MindMate, you can book with a psychiatrist who can discuss this with you directly.\n\nWhat's your biggest concern about medication?"
  }
];
